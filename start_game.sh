...
if [ -f $SERVER_GAME_DIR/ShooterGame/Binaries/Win64/ArkAscendedServer.exe ]; then
    echo "Found ArkAscendedServer.exe binary..."
else
    echo "!!! ArkAscendedServer.exe binary NOT FOUND !!!"
    echo "!!! ArkAscendedServer.exe binary NOT FOUND !!!"
    echo "!!! ArkAscendedServer.exe binary NOT FOUND !!!"
fi
